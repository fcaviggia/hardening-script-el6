...
#Rule Title: Global initialization files' library search paths must contain only absolute paths.
#
...
# grep LD_LIBRARY_PATH /etc/profile /etc/bashrc /etc/csh.login /etc/csh.cshrc /etc/environment /etc/.login /etc/security/environ /etc/profile.d/*
...
#
#Fix Text: Edit the global initialization file and remove the relative path entry from the library search path variable.   
#######################DISA INFORMATION###############################

echo '==================================================='
echo ' Patching GEN001845: Remove LD_LIBRARY_PATH for' 
echo '                     Global Initialization Files'
echo '==================================================='
